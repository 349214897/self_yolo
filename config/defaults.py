...
# Image ColorJitter
_C.INPUT.BRIGHTNESS = 0.5
_C.INPUT.CONTRAST = 0.6
...
_C.OUT_SIZE = (28,28)
_C.IN_SIZE = [448,448]
_C.ANCHORS=[(2.16, 2.38), (6.84, 8.82),(13.26, 22.38), (18.42, 10.11), (25.62, 21.52)]
_C.CLASS_NUM=21
_C.LR=0.001
_C.SAVE_PERIOD = 500
_C.SHOW_PERIOD = 5
...
#POSTPROCESS
_C.POSTPROCESS = CN()
_C.POSTPROCESS.THRESH = 0.7
_C.POSTPROCESS.NMS_THRESH =0.3
_C.POSTPROCESS.SHOW_GT = False
...
_C.SAMPLE_IGNORE_IOU_THRESH =0.3
